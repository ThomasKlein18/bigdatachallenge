...
dataset = read_recurrent_dataset("/Users/thomasklein/Projects/BremenBigDataChallenge2019/bigdatachallenge/data/old/old_rawchallenge.tfrecords",
                            80, 
...
model = tf.keras.models.load_model("/Users/thomasklein/Projects/BremenBigDataChallenge2019/bigdatachallenge/models/model_archive/"+name+"/"+name+".h5")
